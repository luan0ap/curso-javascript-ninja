(function () {
  ...
  */
  ...
  function showOperationMessage ( opr, num1, num2 ) {
    return 'A operação ' + num1 + opr +  num2 + ' =';
  }
  ...
  */
  ...
  function showErrorMessage ( opr ) {
    return 'Operação "' + opr + '" não permitida!'
  }
