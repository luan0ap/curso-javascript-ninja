( function () {
  ...
  */
  ...
  console.log(cleanCPF('735 500 794 - 2'))
  ...
  */
  ...
  console.log( cleanCPF('735 500 794 - 2').replace(/(\d{3})(\d{3})(\d{3})(\d{2})/g), '$1.$2.$3-$4' )
  ...
  */
  ...
  console.log( '<div><ul><li></li><li></li><li><span></span></li></ul></div>'.match(/<\w+><\/\w+>/) )
